...
vector_store = DatabricksVectorSearch(
  endpoint="one-env-shared-endpoint-13", # TODO: Fill in with your VS endpoint name
  index_name="kyra_wulffert.poc_doc_management.db_doc_poc_doc_management_sequential", # TODO: Fill in with your VS index name
  columns=[
  "uuid",
  "content",
  "category",
...
retriever_tool = create_retriever_tool(
  vector_store,
  name="docs_retriever", # TODO: Fill in your retriever's name
  description="Finds documentation related to topic", # TODO: Fill in your retriever's description to help the LLM choose this tool
)
...
for event in agent.stream({"messages": [{"role": "user", "content": "What is DSO??"}]}):
    print(event,"\n")

# COMMAND ----------

for event in agent.stream({"messages": [{"role": "user", "content": "What are the financial incentives for Distribution Network Operators under RIIO-ED2??"}]}):
    print(event,"\n")
