...
w = WorkspaceClient()
config = ModelConfig(development_config="new_rag_chain_config.yaml")
...
input_example = {
    "messages": [{"role": "user", "content": "get my latest bill"}]
}
...
with mlflow.start_run():
    logged_agent_info = mlflow.pyfunc.log_model(
        ...
        model_config="new_rag_chain_config.yaml",
        resources=resources,
    )
...
model_name = "poc_doc_management_agent_system"
